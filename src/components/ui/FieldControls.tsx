...
export function PaginationBar({ label = 'Showing 1-10 of 24 records' }: { label?: string }) {
  return (
    <div className='flex flex-wrap items-center justify-between gap-3 rounded-lg border border-slate-200 bg-white px-4 py-3 text-sm'>
      ...
      <div className='flex flex-wrap items-center gap-2'>
        <Select className='h-9 w-28' label='Rows Per Page' options={[{ value: '10', label: '10 rows' }, { value: '25', label: '25 rows' }, { value: '50', label: '50 rows' }]} />
